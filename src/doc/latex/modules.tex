...
\end{DoxyCompactList}
\item \contentsline{section}{Constraining the Secondary Structure Recursions}{\pageref{group__constraints}}{}
\begin{DoxyCompactList}
...
\begin{DoxyCompactList}
\item \contentsline{section}{Generalized Soft Constraints}{\pageref{group__generalized__sc}}{}
\end{DoxyCompactList}
\end{DoxyCompactList}
\end{DoxyCompactList}
