...
00002 \textcolor{preprocessor}{}\textcolor{preprocessor}{#define VIENNA\_RNA\_PACKAGE\_UTILS\_H}
...
00008 \textcolor{preprocessor}{}\textcolor{preprocessor}{# ifdef \_\_GNUC\_\_}
00009 \textcolor{preprocessor}{}\textcolor{preprocessor}{#  define DEPRECATED(func) func \_\_attribute\_\_ ((deprecated))}
...
00013 \textcolor{preprocessor}{}\textcolor{preprocessor}{#else}
00014 \textcolor{preprocessor}{}\textcolor{preprocessor}{# define DEPRECATED(func) func}
...
00035 \textcolor{preprocessor}{}\textcolor{preprocessor}{#define PRIVATE static}
...
00142 \textcolor{preprocessor}{}\textcolor{comment}{/* use dmalloc library to check for memory management bugs */}
00143 \textcolor{preprocessor}{#include "dmalloc.h"}
00144 \textcolor{preprocessor}{#define vrna\_alloc(S)       calloc(1,(S))}
00145 \textcolor{preprocessor}{}\textcolor{preprocessor}{#define vrna\_realloc(p, S)  xrealloc(p, S)}
00146 \textcolor{preprocessor}{}\textcolor{preprocessor}{#else}
