...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000022}{Deprecated}]Usage of this function is discouraged! This function only free's memory allocated by old A\-P\-I function calls. Memory allocated by any of the new A\-P\-I calls (starting with vrna\-\_\-) will be not affected!\end{DoxyRefDesc}
