/*
  ...
  gengetopt -i mmfold.ggo --file-name=mmfold_cmdl --include-getopt --default-optional --func-name=mmfold_cmdline_parser --arg-struct-name=mmfold_args_info
...
const char *mmfold_args_info_detailed_help[] = {
  ...
  "  Its argument is a comma separated list of additionally allowed pairs. If the\n  first character is a \"-\" then AB will imply that AB and BA are allowed\n  pairs.\n  e.g. mmfold -nsp -GA  will allow GA and AG pairs. Nonstandard pairs are\n  given 0 stacking energy.\n\n",
...
{
  mmfold_args_info_full_help[0] = mmfold_args_info_detailed_help[0];
  mmfold_args_info_full_help[1] = mmfold_args_info_detailed_help[1];
  mmfold_args_info_full_help[2] = mmfold_args_info_detailed_help[2];
  mmfold_args_info_full_help[3] = mmfold_args_info_detailed_help[3];
  mmfold_args_info_full_help[4] = mmfold_args_info_detailed_help[4];
  mmfold_args_info_full_help[5] = mmfold_args_info_detailed_help[5];
  mmfold_args_info_full_help[6] = mmfold_args_info_detailed_help[6];
  mmfold_args_info_full_help[7] = mmfold_args_info_detailed_help[7];
  mmfold_args_info_full_help[8] = mmfold_args_info_detailed_help[9];
  mmfold_args_info_full_help[9] = mmfold_args_info_detailed_help[11];
  mmfold_args_info_full_help[10] = mmfold_args_info_detailed_help[12];
  mmfold_args_info_full_help[11] = mmfold_args_info_detailed_help[13];
  mmfold_args_info_full_help[12] = mmfold_args_info_detailed_help[14];
  mmfold_args_info_full_help[13] = mmfold_args_info_detailed_help[15];
  mmfold_args_info_full_help[14] = mmfold_args_info_detailed_help[16];
  mmfold_args_info_full_help[15] = mmfold_args_info_detailed_help[17];
  mmfold_args_info_full_help[16] = mmfold_args_info_detailed_help[19];
  mmfold_args_info_full_help[17] = mmfold_args_info_detailed_help[21];
  mmfold_args_info_full_help[18] = mmfold_args_info_detailed_help[22];
  mmfold_args_info_full_help[19] = mmfold_args_info_detailed_help[23];
  mmfold_args_info_full_help[20] = mmfold_args_info_detailed_help[24];
  mmfold_args_info_full_help[21] = mmfold_args_info_detailed_help[26];
  mmfold_args_info_full_help[22] = mmfold_args_info_detailed_help[28];
  mmfold_args_info_full_help[23] = mmfold_args_info_detailed_help[30];
  mmfold_args_info_full_help[24] = mmfold_args_info_detailed_help[31];
  mmfold_args_info_full_help[25] = mmfold_args_info_detailed_help[32];
  mmfold_args_info_full_help[26] = mmfold_args_info_detailed_help[34];
  mmfold_args_info_full_help[27] = mmfold_args_info_detailed_help[36];
  mmfold_args_info_full_help[28] = mmfold_args_info_detailed_help[38];
  mmfold_args_info_full_help[29] = mmfold_args_info_detailed_help[39];
  mmfold_args_info_full_help[30] = mmfold_args_info_detailed_help[41];
  mmfold_args_info_full_help[31] = mmfold_args_info_detailed_help[43];
  mmfold_args_info_full_help[32] = mmfold_args_info_detailed_help[44];
  mmfold_args_info_full_help[33] = mmfold_args_info_detailed_help[45];
  mmfold_args_info_full_help[34] = mmfold_args_info_detailed_help[46];
  mmfold_args_info_full_help[35] = mmfold_args_info_detailed_help[47];
  mmfold_args_info_full_help[36] = mmfold_args_info_detailed_help[49];
  mmfold_args_info_full_help[37] = mmfold_args_info_detailed_help[51];
  mmfold_args_info_full_help[38] = mmfold_args_info_detailed_help[52];
  mmfold_args_info_full_help[39] = mmfold_args_info_detailed_help[53];
  mmfold_args_info_full_help[40] = mmfold_args_info_detailed_help[55];
  mmfold_args_info_full_help[41] = mmfold_args_info_detailed_help[57];
  mmfold_args_info_full_help[42] = mmfold_args_info_detailed_help[58];
  mmfold_args_info_full_help[43] = mmfold_args_info_detailed_help[60];
  mmfold_args_info_full_help[44] = 0;
  
}

const char *mmfold_args_info_full_help[45];

static void
init_help_array(void)
{
  mmfold_args_info_help[0] = mmfold_args_info_detailed_help[0];
  mmfold_args_info_help[1] = mmfold_args_info_detailed_help[1];
  mmfold_args_info_help[2] = mmfold_args_info_detailed_help[2];
  mmfold_args_info_help[3] = mmfold_args_info_detailed_help[3];
  mmfold_args_info_help[4] = mmfold_args_info_detailed_help[4];
  mmfold_args_info_help[5] = mmfold_args_info_detailed_help[5];
  mmfold_args_info_help[6] = mmfold_args_info_detailed_help[6];
  mmfold_args_info_help[7] = mmfold_args_info_detailed_help[7];
  mmfold_args_info_help[8] = mmfold_args_info_detailed_help[9];
  mmfold_args_info_help[9] = mmfold_args_info_detailed_help[11];
  mmfold_args_info_help[10] = mmfold_args_info_detailed_help[13];
  mmfold_args_info_help[11] = mmfold_args_info_detailed_help[14];
  mmfold_args_info_help[12] = mmfold_args_info_detailed_help[15];
  mmfold_args_info_help[13] = mmfold_args_info_detailed_help[16];
  mmfold_args_info_help[14] = mmfold_args_info_detailed_help[17];
  mmfold_args_info_help[15] = mmfold_args_info_detailed_help[19];
  mmfold_args_info_help[16] = mmfold_args_info_detailed_help[21];
  mmfold_args_info_help[17] = mmfold_args_info_detailed_help[22];
  mmfold_args_info_help[18] = mmfold_args_info_detailed_help[23];
  mmfold_args_info_help[19] = mmfold_args_info_detailed_help[24];
  mmfold_args_info_help[20] = mmfold_args_info_detailed_help[26];
  mmfold_args_info_help[21] = mmfold_args_info_detailed_help[30];
  mmfold_args_info_help[22] = mmfold_args_info_detailed_help[31];
  mmfold_args_info_help[23] = mmfold_args_info_detailed_help[32];
  mmfold_args_info_help[24] = mmfold_args_info_detailed_help[34];
  mmfold_args_info_help[25] = mmfold_args_info_detailed_help[38];
  mmfold_args_info_help[26] = mmfold_args_info_detailed_help[43];
  mmfold_args_info_help[27] = mmfold_args_info_detailed_help[44];
  mmfold_args_info_help[28] = mmfold_args_info_detailed_help[45];
  mmfold_args_info_help[29] = mmfold_args_info_detailed_help[46];
  mmfold_args_info_help[30] = mmfold_args_info_detailed_help[47];
  mmfold_args_info_help[31] = mmfold_args_info_detailed_help[49];
  mmfold_args_info_help[32] = mmfold_args_info_detailed_help[51];
  mmfold_args_info_help[33] = mmfold_args_info_detailed_help[52];
  mmfold_args_info_help[34] = mmfold_args_info_detailed_help[53];
  mmfold_args_info_help[35] = mmfold_args_info_detailed_help[60];
  mmfold_args_info_help[36] = 0;
  
}

const char *mmfold_args_info_help[37];
...
typedef enum {ARG_NO
  ...
  , ARG_FLOAT
  , ARG_DOUBLE
} mmfold_cmdline_parser_arg_type;

static
void clear_given (struct mmfold_args_info *args_info);
static
void clear_args (struct mmfold_args_info *args_info);

static int
mmfold_cmdline_parser_internal (int argc, char **argv, struct mmfold_args_info *args_info,
                        struct mmfold_cmdline_parser_params *params, const char *additional_error);

static int
mmfold_cmdline_parser_required2 (struct mmfold_args_info *args_info, const char *prog_name, const char *additional_error);
...
static
void init_args_info(struct mmfold_args_info *args_info)
{
  init_full_help_array(); 
  init_help_array(); 
  args_info->help_help = mmfold_args_info_detailed_help[0] ;
  args_info->detailed_help_help = mmfold_args_info_detailed_help[1] ;
  args_info->full_help_help = mmfold_args_info_detailed_help[2] ;
  args_info->version_help = mmfold_args_info_detailed_help[3] ;
  args_info->verbose_help = mmfold_args_info_detailed_help[6] ;
  args_info->infile_help = mmfold_args_info_detailed_help[7] ;
  args_info->outfile_help = mmfold_args_info_detailed_help[9] ;
  args_info->noPS_help = mmfold_args_info_detailed_help[11] ;
  args_info->layout_type_help = mmfold_args_info_detailed_help[12] ;
  args_info->noconv_help = mmfold_args_info_detailed_help[13] ;
  args_info->maxBPspan_help = mmfold_args_info_detailed_help[16] ;
  args_info->constraint_help = mmfold_args_info_detailed_help[17] ;
  args_info->batch_help = mmfold_args_info_detailed_help[19] ;
  args_info->canonicalBPonly_help = mmfold_args_info_detailed_help[21] ;
  args_info->enforceConstraint_help = mmfold_args_info_detailed_help[22] ;
  args_info->shape_help = mmfold_args_info_detailed_help[23] ;
  args_info->shapeMethod_help = mmfold_args_info_detailed_help[24] ;
  args_info->shapeConversion_help = mmfold_args_info_detailed_help[26] ;
  args_info->motif_help = mmfold_args_info_detailed_help[28] ;
  args_info->partfunc_help = mmfold_args_info_detailed_help[32] ;
  args_info->MEA_help = mmfold_args_info_detailed_help[34] ;
  args_info->pfScale_help = mmfold_args_info_detailed_help[36] ;
  args_info->circ_help = mmfold_args_info_detailed_help[38] ;
  args_info->ImFeelingLucky_help = mmfold_args_info_detailed_help[39] ;
  args_info->bppmThreshold_help = mmfold_args_info_detailed_help[41] ;
  args_info->gquad_help = mmfold_args_info_detailed_help[43] ;
  args_info->temp_help = mmfold_args_info_detailed_help[45] ;
  args_info->noTetra_help = mmfold_args_info_detailed_help[46] ;
  args_info->dangles_help = mmfold_args_info_detailed_help[47] ;
  args_info->noLP_help = mmfold_args_info_detailed_help[49] ;
  args_info->noGU_help = mmfold_args_info_detailed_help[51] ;
  args_info->noClosingGU_help = mmfold_args_info_detailed_help[52] ;
  args_info->paramFile_help = mmfold_args_info_detailed_help[53] ;
  args_info->nsp_help = mmfold_args_info_detailed_help[55] ;
  args_info->energyModel_help = mmfold_args_info_detailed_help[57] ;
  args_info->betaScale_help = mmfold_args_info_detailed_help[58] ;
  
}

void
mmfold_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(MMFOLD_CMDLINE_PARSER_PACKAGE_NAME) ? MMFOLD_CMDLINE_PARSER_PACKAGE_NAME : MMFOLD_CMDLINE_PARSER_PACKAGE),
     MMFOLD_CMDLINE_PARSER_VERSION);

  if (strlen(mmfold_args_info_versiontext) > 0)
    printf("\n%s\n", mmfold_args_info_versiontext);
}

static void print_help_common(void) {
  mmfold_cmdline_parser_print_version ();

  if (strlen(mmfold_args_info_purpose) > 0)
    printf("\n%s\n", mmfold_args_info_purpose);

  if (strlen(mmfold_args_info_usage) > 0)
    printf("\n%s\n", mmfold_args_info_usage);

  printf("\n");

  if (strlen(mmfold_args_info_description) > 0)
    printf("%s\n\n", mmfold_args_info_description);
}

void
mmfold_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (mmfold_args_info_help[i])
    printf("%s\n", mmfold_args_info_help[i++]);
}

void
mmfold_cmdline_parser_print_full_help (void)
{
  int i = 0;
  print_help_common();
  while (mmfold_args_info_full_help[i])
    printf("%s\n", mmfold_args_info_full_help[i++]);
}

void
mmfold_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (mmfold_args_info_detailed_help[i])
    printf("%s\n", mmfold_args_info_detailed_help[i++]);
}

void
mmfold_cmdline_parser_init (struct mmfold_args_info *args_info)
{
...
void
mmfold_cmdline_parser_params_init(struct mmfold_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct mmfold_cmdline_parser_params *
mmfold_cmdline_parser_params_create(void)
{
  struct mmfold_cmdline_parser_params *params =
    (struct mmfold_cmdline_parser_params *)malloc(sizeof(struct mmfold_cmdline_parser_params));
  mmfold_cmdline_parser_params_init(params);
  return params;
}
...
static void
mmfold_cmdline_parser_release (struct mmfold_args_info *args_info)
{
...
int
mmfold_cmdline_parser_dump(FILE *outfile, struct mmfold_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", MMFOLD_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
mmfold_cmdline_parser_file_save(const char *filename, struct mmfold_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", MMFOLD_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = mmfold_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
mmfold_cmdline_parser_free (struct mmfold_args_info *args_info)
{
  mmfold_cmdline_parser_release (args_info);
}
...
int
mmfold_cmdline_parser (int argc, char **argv, struct mmfold_args_info *args_info)
{
  return mmfold_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
mmfold_cmdline_parser_ext (int argc, char **argv, struct mmfold_args_info *args_info,
                   struct mmfold_cmdline_parser_params *params)
{
  int result;
  result = mmfold_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
mmfold_cmdline_parser2 (int argc, char **argv, struct mmfold_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct mmfold_cmdline_parser_params params;
...
int
mmfold_cmdline_parser_required (struct mmfold_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (mmfold_cmdline_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
 ...
 * @param check_ambiguity @see mmfold_cmdline_parser_params.check_ambiguity
 * @param override @see mmfold_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               mmfold_cmdline_parser_arg_type arg_type,
...
int
mmfold_cmdline_parser_internal (
  int argc, char **argv, struct mmfold_args_info *args_info,
                        struct mmfold_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct mmfold_args_info local_args_info;
  ...
  if (initialize)
    mmfold_cmdline_parser_init (args_info);

  mmfold_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          mmfold_cmdline_parser_print_help ();
          mmfold_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            mmfold_cmdline_parser_print_detailed_help ();
            mmfold_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }

          if (strcmp (long_options[option_index].name, "full-help") == 0) {
            mmfold_cmdline_parser_print_full_help ();
            mmfold_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", MMFOLD_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error_occurred += mmfold_cmdline_parser_required2 (args_info, argv[0], additional_error);
    }

  mmfold_cmdline_parser_release (&local_args_info);
