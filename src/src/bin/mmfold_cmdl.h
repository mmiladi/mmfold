...
#ifndef MMFOLD_CMDL_H
#define MMFOLD_CMDL_H
...
#ifndef MMFOLD_CMDLINE_PARSER_PACKAGE
/** @brief the program name (used for printing errors) */
#define MMFOLD_CMDLINE_PARSER_PACKAGE "mmfold"
#endif

#ifndef MMFOLD_CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define MMFOLD_CMDLINE_PARSER_PACKAGE_NAME "mmfold"
#endif

#ifndef MMFOLD_CMDLINE_PARSER_VERSION
/** @brief the program version */
#define MMFOLD_CMDLINE_PARSER_VERSION VERSION
#endif

/** @brief Where the command line options are stored */
struct mmfold_args_info
{
...
struct mmfold_cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure mmfold_args_info (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure mmfold_args_info (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *mmfold_args_info_purpose;
/** @brief the usage string of the program */
extern const char *mmfold_args_info_usage;
/** @brief the description string of the program */
extern const char *mmfold_args_info_description;
/** @brief all the lines making the help output */
extern const char *mmfold_args_info_help[];
/** @brief all the lines making the full help output (including hidden options) */
extern const char *mmfold_args_info_full_help[];
/** @brief all the lines making the detailed help output (including hidden options and details) */
extern const char *mmfold_args_info_detailed_help[];
 ...
 */
int mmfold_cmdline_parser (int argc, char **argv,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 * @deprecated use mmfold_cmdline_parser_ext() instead
 */
int mmfold_cmdline_parser2 (int argc, char **argv,
  struct mmfold_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int mmfold_cmdline_parser_ext (int argc, char **argv,
  struct mmfold_args_info *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int mmfold_cmdline_parser_dump(FILE *outfile,
  struct mmfold_args_info *args_info);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int mmfold_cmdline_parser_file_save(const char *filename,
  struct mmfold_args_info *args_info);

/**
 * Print the help
 */
void mmfold_cmdline_parser_print_help(void);
/**
 * Print the full help (including hidden options)
 */
void mmfold_cmdline_parser_print_full_help(void);
/**
 * Print the detailed help (including hidden options and details)
 */
void mmfold_cmdline_parser_print_detailed_help(void);
/**
 * Print the version
 */
void mmfold_cmdline_parser_print_version(void);

/**
 * Initializes all the fields a mmfold_cmdline_parser_params structure
 * to their default values
 * @param params the structure to initialize
 */
void mmfold_cmdline_parser_params_init(struct mmfold_cmdline_parser_params *params);

/**
 * Allocates dynamically a mmfold_cmdline_parser_params structure and initializes
 * all its fields to their default values
 * @return the created and initialized mmfold_cmdline_parser_params structure
 */
struct mmfold_cmdline_parser_params *mmfold_cmdline_parser_params_create(void);

/**
 * Initializes the passed mmfold_args_info structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void mmfold_cmdline_parser_init (struct mmfold_args_info *args_info);
/**
 * Deallocates the string fields of the mmfold_args_info structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void mmfold_cmdline_parser_free (struct mmfold_args_info *args_info);
 ...
 * @return
 */
int mmfold_cmdline_parser_required (struct mmfold_args_info *args_info,
