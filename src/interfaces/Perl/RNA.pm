...
sub VRNA_GQUAD_MAX_STACK_SIZE () { $RNAc::VRNA_GQUAD_MAX_STACK_SIZE }
sub VRNA_GQUAD_MIN_STACK_SIZE () { $RNAc::VRNA_GQUAD_MIN_STACK_SIZE }
sub VRNA_GQUAD_MAX_LINKER_LENGTH () { $RNAc::VRNA_GQUAD_MAX_LINKER_LENGTH }
sub VRNA_GQUAD_MIN_LINKER_LENGTH () { $RNAc::VRNA_GQUAD_MIN_LINKER_LENGTH }
sub VRNA_GQUAD_MIN_BOX_SIZE () { $RNAc::VRNA_GQUAD_MIN_BOX_SIZE }
sub VRNA_GQUAD_MAX_BOX_SIZE () { $RNAc::VRNA_GQUAD_MAX_BOX_SIZE }
...
sub VRNA_GQUAD_MISMATCH_PENALTY () { $RNAc::VRNA_GQUAD_MISMATCH_PENALTY }
sub VRNA_GQUAD_MISMATCH_NUM_ALI () { $RNAc::VRNA_GQUAD_MISMATCH_NUM_ALI }
sub NBASES () { $RNAc::NBASES }
sub VRNA_MODEL_DEFAULT_TEMPERATURE () { $RNAc::VRNA_MODEL_DEFAULT_TEMPERATURE }
sub VRNA_MODEL_DEFAULT_PF_SCALE () { $RNAc::VRNA_MODEL_DEFAULT_PF_SCALE }
sub VRNA_MODEL_DEFAULT_BETA_SCALE () { $RNAc::VRNA_MODEL_DEFAULT_BETA_SCALE }
sub VRNA_MODEL_DEFAULT_DANGLES () { $RNAc::VRNA_MODEL_DEFAULT_DANGLES }
sub VRNA_MODEL_DEFAULT_SPECIAL_HP () { $RNAc::VRNA_MODEL_DEFAULT_SPECIAL_HP }
sub VRNA_MODEL_DEFAULT_NO_LP () { $RNAc::VRNA_MODEL_DEFAULT_NO_LP }
sub VRNA_MODEL_DEFAULT_NO_GU () { $RNAc::VRNA_MODEL_DEFAULT_NO_GU }
sub VRNA_MODEL_DEFAULT_NO_GU_CLOSURE () { $RNAc::VRNA_MODEL_DEFAULT_NO_GU_CLOSURE }
sub VRNA_MODEL_DEFAULT_CIRC () { $RNAc::VRNA_MODEL_DEFAULT_CIRC }
sub VRNA_MODEL_DEFAULT_GQUAD () { $RNAc::VRNA_MODEL_DEFAULT_GQUAD }
sub VRNA_MODEL_DEFAULT_CANONICAL_BP () { $RNAc::VRNA_MODEL_DEFAULT_CANONICAL_BP }
sub VRNA_MODEL_DEFAULT_UNIQ_ML () { $RNAc::VRNA_MODEL_DEFAULT_UNIQ_ML }
sub VRNA_MODEL_DEFAULT_ENERGY_SET () { $RNAc::VRNA_MODEL_DEFAULT_ENERGY_SET }
sub VRNA_MODEL_DEFAULT_BACKTRACK () { $RNAc::VRNA_MODEL_DEFAULT_BACKTRACK }
sub VRNA_MODEL_DEFAULT_BACKTRACK_TYPE () { $RNAc::VRNA_MODEL_DEFAULT_BACKTRACK_TYPE }
sub VRNA_MODEL_DEFAULT_COMPUTE_BPP () { $RNAc::VRNA_MODEL_DEFAULT_COMPUTE_BPP }
sub VRNA_MODEL_DEFAULT_MAX_BP_SPAN () { $RNAc::VRNA_MODEL_DEFAULT_MAX_BP_SPAN }
sub VRNA_MODEL_DEFAULT_WINDOW_SIZE () { $RNAc::VRNA_MODEL_DEFAULT_WINDOW_SIZE }
sub VRNA_MODEL_DEFAULT_LOG_ML () { $RNAc::VRNA_MODEL_DEFAULT_LOG_ML }
sub VRNA_MODEL_DEFAULT_ALI_OLD_EN () { $RNAc::VRNA_MODEL_DEFAULT_ALI_OLD_EN }
sub VRNA_MODEL_DEFAULT_ALI_RIBO () { $RNAc::VRNA_MODEL_DEFAULT_ALI_RIBO }
sub VRNA_MODEL_DEFAULT_ALI_CV_FACT () { $RNAc::VRNA_MODEL_DEFAULT_ALI_CV_FACT }
sub VRNA_MODEL_DEFAULT_ALI_NC_FACT () { $RNAc::VRNA_MODEL_DEFAULT_ALI_NC_FACT }
...
sub VRNA_OPTION_MFE () { $RNAc::VRNA_OPTION_MFE }
sub VRNA_OPTION_PF () { $RNAc::VRNA_OPTION_PF }
sub VRNA_OPTION_HYBRID () { $RNAc::VRNA_OPTION_HYBRID }
sub VRNA_OPTION_EVAL_ONLY () { $RNAc::VRNA_OPTION_EVAL_ONLY }
sub VRNA_OPTION_WINDOW () { $RNAc::VRNA_OPTION_WINDOW }
sub VRNA_INPUT_ERROR () { $RNAc::VRNA_INPUT_ERROR }
sub VRNA_INPUT_QUIT () { $RNAc::VRNA_INPUT_QUIT }
sub VRNA_INPUT_MISC () { $RNAc::VRNA_INPUT_MISC }
sub VRNA_INPUT_FASTA_HEADER () { $RNAc::VRNA_INPUT_FASTA_HEADER }
sub VRNA_INPUT_SEQUENCE () { $RNAc::VRNA_INPUT_SEQUENCE }
sub VRNA_INPUT_CONSTRAINT () { $RNAc::VRNA_INPUT_CONSTRAINT }
sub VRNA_INPUT_NO_TRUNCATION () { $RNAc::VRNA_INPUT_NO_TRUNCATION }
sub VRNA_INPUT_NO_REST () { $RNAc::VRNA_INPUT_NO_REST }
sub VRNA_INPUT_NO_SPAN () { $RNAc::VRNA_INPUT_NO_SPAN }
sub VRNA_INPUT_NOSKIP_BLANK_LINES () { $RNAc::VRNA_INPUT_NOSKIP_BLANK_LINES }
sub VRNA_INPUT_BLANK_LINE () { $RNAc::VRNA_INPUT_BLANK_LINE }
sub VRNA_INPUT_NOSKIP_COMMENTS () { $RNAc::VRNA_INPUT_NOSKIP_COMMENTS }
sub VRNA_INPUT_COMMENT () { $RNAc::VRNA_INPUT_COMMENT }
sub VRNA_OPTION_MULTILINE () { $RNAc::VRNA_OPTION_MULTILINE }
sub FILENAME_MAX_LENGTH () { $RNAc::FILENAME_MAX_LENGTH }
sub FILENAME_ID_LENGTH () { $RNAc::FILENAME_ID_LENGTH }
sub PI () { $RNAc::PI }
sub PIHALF () { $RNAc::PIHALF }
sub VRNA_PLOT_TYPE_SIMPLE () { $RNAc::VRNA_PLOT_TYPE_SIMPLE }
sub VRNA_PLOT_TYPE_NAVIEW () { $RNAc::VRNA_PLOT_TYPE_NAVIEW }
sub VRNA_PLOT_TYPE_CIRCULAR () { $RNAc::VRNA_PLOT_TYPE_CIRCULAR }
sub VRNA_CONSTRAINT_DB_PIPE () { $RNAc::VRNA_CONSTRAINT_DB_PIPE }
sub VRNA_CONSTRAINT_DB_DOT () { $RNAc::VRNA_CONSTRAINT_DB_DOT }
sub VRNA_CONSTRAINT_DB_X () { $RNAc::VRNA_CONSTRAINT_DB_X }
sub VRNA_CONSTRAINT_DB_ANG_BRACK () { $RNAc::VRNA_CONSTRAINT_DB_ANG_BRACK }
sub VRNA_CONSTRAINT_DB_RND_BRACK () { $RNAc::VRNA_CONSTRAINT_DB_RND_BRACK }
sub VRNA_CONSTRAINT_DB_INTRAMOL () { $RNAc::VRNA_CONSTRAINT_DB_INTRAMOL }
sub VRNA_CONSTRAINT_DB_INTERMOL () { $RNAc::VRNA_CONSTRAINT_DB_INTERMOL }
sub VRNA_CONSTRAINT_DB_GQUAD () { $RNAc::VRNA_CONSTRAINT_DB_GQUAD }
sub VRNA_CONSTRAINT_DB_ENFORCE_BP () { $RNAc::VRNA_CONSTRAINT_DB_ENFORCE_BP }
sub VRNA_CONSTRAINT_MULTILINE () { $RNAc::VRNA_CONSTRAINT_MULTILINE }
sub VRNA_CONSTRAINT_NO_HEADER () { $RNAc::VRNA_CONSTRAINT_NO_HEADER }
sub VRNA_CONSTRAINT_ALL () { $RNAc::VRNA_CONSTRAINT_ALL }
sub VRNA_CONSTRAINT_DB () { $RNAc::VRNA_CONSTRAINT_DB }
sub VRNA_CONSTRAINT_FILE () { $RNAc::VRNA_CONSTRAINT_FILE }
sub VRNA_CONSTRAINT_SOFT_MFE () { $RNAc::VRNA_CONSTRAINT_SOFT_MFE }
sub VRNA_CONSTRAINT_SOFT_PF () { $RNAc::VRNA_CONSTRAINT_SOFT_PF }
sub VRNA_DECOMP_PAIR_HP () { $RNAc::VRNA_DECOMP_PAIR_HP }
sub VRNA_DECOMP_PAIR_IL () { $RNAc::VRNA_DECOMP_PAIR_IL }
sub VRNA_DECOMP_PAIR_ML () { $RNAc::VRNA_DECOMP_PAIR_ML }
sub VRNA_DECOMP_ML_ML_ML () { $RNAc::VRNA_DECOMP_ML_ML_ML }
sub VRNA_DECOMP_ML_STEM () { $RNAc::VRNA_DECOMP_ML_STEM }
sub VRNA_DECOMP_ML_ML () { $RNAc::VRNA_DECOMP_ML_ML }
sub VRNA_DECOMP_ML_UP () { $RNAc::VRNA_DECOMP_ML_UP }
sub VRNA_DECOMP_ML_COAXIAL () { $RNAc::VRNA_DECOMP_ML_COAXIAL }
sub VRNA_DECOMP_EXT_EXT () { $RNAc::VRNA_DECOMP_EXT_EXT }
sub VRNA_DECOMP_EXT_UP () { $RNAc::VRNA_DECOMP_EXT_UP }
sub VRNA_DECOMP_EXT_STEM () { $RNAc::VRNA_DECOMP_EXT_STEM }
sub VRNA_DECOMP_EXT_EXT_EXT () { $RNAc::VRNA_DECOMP_EXT_EXT_EXT }
sub VRNA_DECOMP_EXT_STEM_EXT () { $RNAc::VRNA_DECOMP_EXT_STEM_EXT }
sub VRNA_DECOMP_EXT_STEM_OUTSIDE () { $RNAc::VRNA_DECOMP_EXT_STEM_OUTSIDE }
sub VRNA_DECOMP_EXT_EXT_STEM () { $RNAc::VRNA_DECOMP_EXT_EXT_STEM }
sub VRNA_DECOMP_EXT_EXT_STEM1 () { $RNAc::VRNA_DECOMP_EXT_EXT_STEM1 }
sub VRNA_DECOMP_ML_ML_STEM () { $RNAc::VRNA_DECOMP_ML_ML_STEM }
